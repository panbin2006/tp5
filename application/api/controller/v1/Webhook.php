...
class Webhook extends Controller
{
    ...
    public  function pull(){
        ...
        // 获取git服务器提交的数据
        $inputs = input('post.');
        // $path = "/d/code/PHP/zscd01_tp5_test_webhook"; //项目存放物理路径
        $ref = $inputs['ref'];
    ...
    public  function email(){
        ...
        try {
            ...
            $mail->Username = '502752983@qq.com';                // SMTP 用户名  即邮箱的用户名
            $mail->Password = 'ggfacakeirdhbjag';             // SMTP 密码  部分邮箱是授权码(例如163邮箱)
            $mail->SMTPSecure = 'ssl';                    // 允许 TLS 或者ssl协议
            $mail->Port = 465;                            // 服务器端口 25 或者465 具体要看邮箱服务器支持

            $mail->setFrom('502752983@qq.com', 'panbin');  //发件人
            $mail->addAddress('502752983@qq.com', '安韩');  // 收件人
            ...
            $mail->Subject = '这是可达鸭' . time();
            $mail->Body    = '<h1>可达鸭大葱鸭</h1>' . date('Y-m-d H:i:s');
